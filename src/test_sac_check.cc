...
int main () {
    ...
    randomness::RO ro; 
    ro.gen_random_bytes();
    std::vector<Rs> ex_seq(Rs::exceptional_seq(PARTY_NUM + 1).begin() + 1, Rs::exceptional_seq(PARTY_NUM + 1).end());
    ...
    // multiplication_num x PARTY_NUM
    ...
    sacrificing_check<Rs, Rl, k, s>(x_shares_final, y_shares_final, z_shares_final, ex_seq);
